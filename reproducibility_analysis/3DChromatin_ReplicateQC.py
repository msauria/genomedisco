...
def quasar_makeDatasets(metadata_samples,outdir,subset_chromosomes,resolution,running_mode):
    ...
    for line in open(metadata_samples,'r').readlines():
        ...
        script_forquasar.write(os.path.dirname(os.path.abspath(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))))+"/hifive/bin/hifive quasar -p "+quasar_project+' '+quasar_transform+' -r '+resolution+'\n')
...
def QuASAR_rep_wrapper(outdir,parameters,samplename1,samplename2,running_mode):
    ...
    script_comparison.write(os.path.dirname(os.path.abspath(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))))+"/hifive/bin/hifive quasar "+quasar_transform1+' -Q '+quasar_transform2+' -o '+outpath+'\n') 
...
def quasar_qc_wrapper(outdir,parameters,samplename,running_mode):
    ...
    quasar_transform=quasar_data+'/'+samplename+'.quasar_transform'
    subp.check_output(['bash','-c','mkdir -p '+os.path.dirname(outpath)])
    script_comparison.write(os.path.dirname(os.path.abspath(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))))+"/hifive/bin/hifive quasar "+quasar_transform+' -o '+outpath+'\n')
